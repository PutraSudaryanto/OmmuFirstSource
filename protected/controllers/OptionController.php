...
class OptionController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = OmmuOptions::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('OmmuOptions', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Ommu Options');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['OmmuOptions'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'OmmuOptions success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['OmmuOptions'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'OmmuOptions success updated.'));
					//$this->redirect(array('view','id'=>$model->option_id));
					$this->redirect(array('manage'));
				}
			}
