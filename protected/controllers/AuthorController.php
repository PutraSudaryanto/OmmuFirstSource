...
class AuthorController extends Controller
{
	...
	{
		$model=new OmmuAuthors('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['OmmuAuthors'])) {
			$model->attributes=$_GET['OmmuAuthors'];
		}
	...
	{
		$model=new OmmuAuthors;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['OmmuAuthors'])) {
			$model->attributes=$_POST['OmmuAuthors'];
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				OmmuAuthors::model()->updateAll(array(
					'publish' => 1,
				),$criteria);
				...
				OmmuAuthors::model()->deleteAll($criteria);
			}
		}
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ommu-authors-form') {
