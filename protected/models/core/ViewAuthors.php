 ...
 * @created date 1 June 2017, 13:24 WIB
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_core_authors".
 *
 * The followings are the available columns in table '_view_core_authors':
 * @property string $author_id
 * @property string $contacts
 * @property string $contact_all
 */
class ViewAuthors extends CActiveRecord
{
	 ...
	 * @return ViewAuthors the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('author_id, contacts, contact_all', 'safe', 'on'=>'search'),
		);
	}
