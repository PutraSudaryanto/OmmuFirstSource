 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_core_content_menu".
 *
 * The followings are the available columns in table '_view_core_content_menu':
 * @property string $menu_id
 * @property string $title
 */
class ViewContentMenu extends CActiveRecord
{
	 ...
	 * @return ViewContentMenu the static model class
	 */
	...
	{
		return '_view_core_content_menu';
	}
