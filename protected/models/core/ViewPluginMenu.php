 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_core_plugin_menu".
 *
 * The followings are the available columns in table '_view_core_plugin_menu':
 * @property integer $menu_id
 * @property string $title
 */
class ViewPluginMenu extends CActiveRecord
{
	 ...
	 * @return ViewPluginMenu the static model class
	 */
