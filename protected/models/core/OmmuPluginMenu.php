...
class OmmuPluginMenu extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('menu_id, module, enabled, orders, name, icon, url, dialog, attr, creation_date, creation_id, modified_date, modified_id,
	...
	public function relations()
	{
		...
		return array(
			'view_menu' => array(self::BELONGS_TO, 'ViewPluginMenu', 'menu_id'),
