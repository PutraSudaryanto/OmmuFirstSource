...
<?php $this->renderPartial('/plugin_menu/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/plugin_menu/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-ommu-plugin-menu">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
